...
public class SqlBuilder {
     ...
     * table name
     *
     * @param sMainColumns main table columns (ie: "TABLE.COL1, TABLE.COL2,
     * TABLE.COL3")
     * @param sJoinColumns join columns can be null if there is no join in the
     * request (ie: "T2.A, T2.B")
     * @return
     */
     ...
     *
     * @param sQueryCriteria the query criteria ( ie : "T1.C > ?" ), can be null
     ...
     *
     * @param sJoinCriteria the join criteria ( ie : "T1.A = T2.B" ), can be
     * null
     * @param sQueryCriteria the query criteria ( ie : "T1.C > ?" ), can be null
     ...
     *
     * @param sQueryEndOfSelect the complement (ie: "order by .." )
     * @return
     */
